...
if ($_GET[module]=='home'){
  echo "
        ...
        <div class='center_prod_box_big'>
            <div class='product_title_big'>BETRAN TRAVEL</div>
              <div><p>Selamat datang di website kami, sebagai sarana Informasi secara online guna kemudahan dalam mendapatkan info layanan dan informasi lainnya bagi pelanggan kami. BETRAN TRAVEL hadir sejak tahun 2017 guna memenuhi akan kebutuhan transportasi yang nyaman, aman dan terpercaya.</p>
<p>
...
<p>
<img src=images/betrantravel.jpg title='Armada travel betran travel' width=520 height=350 />
</p>
</div>
          </div> 
...
elseif ($_GET[module]=='profilkami'){
  ...
  echo "<div class='center_title_bar'>Profil</div>
        ...
        <div class='center_prod_box_big'>            
                 <div class='product_img_big'>
                 <img src='foto_banner/betrantravel.jpg' border='0' />
            </div>
          <div class='details_big_box'>
            <div class='product_title_big'>Profil BETRAN TRAVEL</div>
...
elseif ($_GET[module]=='carapesan'){
  ...
  echo "<div class='center_title_bar'>Cara Pemesanan</div>
        ...
        <div class='center_prod_box_big'>            
          ...
          <div class='details_big_box'>
            <div class='product_title_big'>Prosedur Pemesanan Tiket di BETRAN TRAVEL </div>
              <div>$r[static_content]</div>
          </div>    
          </div>
            <div class='bottom_prod_box_big'></div>
...
$pesan="Terimakasih telah melakukan pemesanan tiket online di BETRAN TRAVEL <br /><br />  
        Nama: $nama <br />
        Alamat: $alamat <br/>
        Telpon: $telpon <br /><hr />
...
$pesan.="<br /><br />Total : Rp. $total_rp  
         ...
         <br /><br />Silahkan lakukan pembayaran sebanyak Grand Total yang tercantum, rekeningnya: BETRAN TRAVEL
         <br />Apabila sudah transfer, konfirmasi ke nomor: BETRAN TRAVEL";
...
mail("BETRAN TRAVEL",$subjek,$pesan,$dari);
...
$pesan="Terimakasih telah melakukan pemesanan tiket online di BETRAN TRAVEL semoga perjalanan anda menyenangkan <br /><br />  
...
$pesan.="<br /><br />Total : Rp. $total_rp 
         ...
         <br />Apabila sudah transfer, konfirmasi ke pihak BETRAN TRAVEL atau mendatangi kantor BETRAN TRAVEL sesuai alamat kantor";

$subjek="Pemesanan Tiket Online";

$dari = "From: betrantravel\r\n";
$dari .= "Content-type: text/html\r\n";
